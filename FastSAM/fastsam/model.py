...
class FastSAM(YOLO):
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        # feature predictor
        # self.feapredictor = FastSAMFeaturePredictor(overrides=overrides)
        # self.feapredictor.setup_model(model=self.model, verbose=False)
        try:
            return self.predictor(source, stream=stream) # , self.feapredictor(source, stream=stream) # everything_results, features.
